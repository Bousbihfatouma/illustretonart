...
class UserControllerTest extends WebTestCase
{
    ...
    public function testShow(): void
    {
        ...
        $fixture->setAPropos('My Title');
        $fixture->setInstagram('My Title');
        $fixture->setCreated_at('My Title');
        $fixture->setGalerie('My Title');
    ...
    public function testEdit(): void
    {
        ...
        self::assertSame('Something New', $fixture[0]->getAPropos());
        self::assertSame('Something New', $fixture[0]->getInstagram());
        self::assertSame('Something New', $fixture[0]->getCreated_at());
        self::assertSame('Something New', $fixture[0]->getGalerie());
    }
